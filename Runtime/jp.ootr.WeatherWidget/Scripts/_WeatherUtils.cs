...
namespace jp.ootr.WeatherWidget
{
    ...
    public static class _WeatherUtils
    {
        ...
        {
            size = 0;
            if (!data.TryGetValue("weather", out var weatherList))
            {
                return false;
            }
        ...
        public static bool GetWeather(this WeatherData data, int index, out string date, out string tempMin, out string tempMax, out string pop, out string icon, out string weather)
        {
        ...
        {
            office = "";
            if (!data.TryGetValue("publishingOffice", out var officeToken))
            {
                return false;
            }
        ...
        {
            dateTime = "";
            if (!data.TryGetValue("reportDatetime", out var dateTimeToken))
            {
                return false;
            }
        ...
        {
            region = "";
            if (!data.TryGetValue("region", out var regionToken))
            {
                return false;
            }
        ...
        {
            overview = "";
            if (!data.TryGetValue("overview", out var overviewToken))
            {
                return false;
            }
